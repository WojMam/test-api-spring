...
class BasicAuthProductControllerTest {
    ...
    @InjectMocks
    private BasicAuthProductController controller;
    ...
    void getAllProducts_ShouldReturnAllProducts() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/basic-auth/products"))
    ...
    void getProductById_WhenProductExists_ShouldReturnProduct() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/basic-auth/products/1"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void getProductById_WhenProductDoesNotExist_ShouldReturnNotFound() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/basic-auth/products/999"))
    ...
    void getProductsByCategory_ShouldReturnProductsByCategory() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/basic-auth/products/category/Electronics"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$", hasSize(2)))
                .andExpect(jsonPath("$[0].name", is("Laptop")))
    ...
    void createProduct_ShouldReturnCreatedProduct() throws Exception {
        ...
        // When & Then
        mockMvc.perform(post("/basic-auth/products")
    ...
    void updateProduct_WhenProductExists_ShouldReturnUpdatedProduct() throws Exception {
        ...
        // When & Then
        mockMvc.perform(put("/basic-auth/products/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(inputProduct)))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void updateProduct_WhenProductDoesNotExist_ShouldReturnNotFound() throws Exception {
        ...
        // When & Then
        mockMvc.perform(put("/basic-auth/products/999")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(inputProduct)))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteProduct_WhenProductExists_ShouldReturnNoContent() throws Exception {
        ...
        // When & Then
        mockMvc.perform(delete("/basic-auth/products/1"))
    ...
    void deleteProduct_WhenProductDoesNotExist_ShouldReturnNotFound() throws Exception {
        ...
        // When & Then
        mockMvc.perform(delete("/basic-auth/products/999"))
                .andExpect(status().isNotFound());
    }
} 